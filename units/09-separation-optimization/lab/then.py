...
On random Euclidean TSPs of growing size:
  1. The subtour-elimination LP by lazy row generation: bound, rows actually
...
def main():
    print(f"{'n':>4}{'rows that exist':>18}{'LP rows used':>14}{'LP solves':>11}{'LP bound':>10}{'LP s':>7}"
    ...
    for n in (15, 30, 50, 80, 120, 200):
        ...
        exist = 2 ** (n - 1) - 1
        print(f"{n:>4}{exist:>18.3g}{rows:>14}{solves:>11}{value:>10.1f}{lp_s:>7.2f}"
    ...
    print("Every row it used was found by a connected-components or minimum-cut computation.")
